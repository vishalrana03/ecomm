...
const TestimonialData = [
    {
        ...
        text: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia cupiditate, totam consequuntur maiores id eveniet.",
},
    {
        id: 2,
        name: "Satya Nadella",
        ...
        <div data-aos="zoom-in">
            <Slider {...settings}>
                {TestimonialData.map((data) => (
                    ...
                    <div 
                    className='flex flex-col shadow-lg py-8 px-6 mx-4 gap-4 rounded-xl dark:bg-gray-800 bg-primary/10 relative'
                    >
                        <div className='mb-4'>
                            <img src={data.img} 
                            alt="" 
